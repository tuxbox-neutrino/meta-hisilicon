...
IMAGE_CMD:hdfastboot8gb () {
    ...
    echo "bootargs=root=/dev/mmcblk0p23 rootsubdir=linuxrootfs1 kernel=/dev/mmcblk0p19 rootfstype=ext4" >> ${WORKDIR}/STARTUP
    ...
    echo "bootargs=root=/dev/mmcblk0p23 rootsubdir=linuxrootfs1 kernel=/dev/mmcblk0p19 rootfstype=ext4" >> ${WORKDIR}/STARTUP_LINUX_1
    ...
    echo "bootargs=root=/dev/mmcblk0p23 rootsubdir=linuxrootfs2 kernel=/dev/mmcblk0p20 rootfstype=ext4" >> ${WORKDIR}/STARTUP_LINUX_2
    ...
    echo "bootargs=root=/dev/mmcblk0p23 rootsubdir=linuxrootfs3 kernel=/dev/mmcblk0p21 rootfstype=ext4" >> ${WORKDIR}/STARTUP_LINUX_3
